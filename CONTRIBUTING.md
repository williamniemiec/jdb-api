...
- If there is a problem or question while editing the project, create an [issue](https://github.com/williamniemiec/jdb-api/pulls) detailing the problem or question.
...
![step1](https://github.com/williamniemiec/jdb-api/blob/master/docs/img/how-to-generate-jar/step1.png?raw=true)
...
![step3](https://github.com/williamniemiec/jdb-api/blob/master/docs/img/how-to-generate-jar/step3.png?raw=true)
